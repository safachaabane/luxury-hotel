...
function Footer() {
    ...
    <Container className="footer-contain">
     <Row>
      ...
      <Row>
        <Col md={4}><Row><Col md={1} ><img alt="adresse" src={adresse}/></Col><Col  ><p><h5>LUXURY HOTEL</h5><p>Rue de la republique,19</p><p> 1082 Tunis</p><p> Tunisia</p></p></Col></Row>
        <Row className="contact-informations"><Col md={1} > <img alt="adresse" src={position}/></Col><Col><p> <a className='block-information' href="/">Plan d'accés</a></p></Col></Row></Col>
        <Col md={4} className="contact-information">
        <Row ><Col md={1}> <img alt="phone" src={phone}/></Col><Col> <p className='block-information'>Tél.: +21671000000</p></Col></Row>
        <Row ><Col md={1}><img alt="email" src={email}/></Col><Col><p className='block-information'><a href="mailto:safa1chaabane@gmail.com">contact@luxuryhotel.com</a></p></Col></Row>
        <Row ><Col md={1}><img alt="work" src={work}/></Col><Col><p className='block-information'>MA 800 50</p></Col></Row>
        </Col>
